    ...
    <Formik
                ...
                {({ isSubmitting }) => {
                        return (
                            ...
                            <Form action="" className="mt-6 mb-0  w-full space-y-4 rounded-lg p-8 shadow-2xl">
                              ...
                              <div className="relative mt-1">
                                ...
                                <p className=' text-center'> Upload Image in passport photo size (600 X 600) </p> 
                                <button className=' mt-10 bg-pri text-white w-[110px] rounded-md h-[50px] font-bold text-lg '> upload </button>
