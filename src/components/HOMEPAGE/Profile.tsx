...
const Profile = () => {
  return (
    <div className="flex lg:flex-row flex-col items-center md:gap-x-[3em] gap-y-[1em] md:px-[6em] px-[1em] md:my-[10rem] my-[6rem]">
      ...
      <div className="flex flex-col gap-y-5">
        ...
        <button className="bg-pri_var_1 rounded-md text-white md:text-[24px] text-[18px] px-[1em] py-[1em] hover:bg-pri animate-all duration-300">
          See full profile
        </button>
      </div>
    </div>
